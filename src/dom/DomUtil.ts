import { any3d, ie3d } from '@/core/Browser';
import { splitWords, trim } from '@/core/Util';
...
type CSSStyleKeys = keyof CSSStyleDeclaration;
...
export function getStyle(
  el: HTMLElement,
  style: CSSStyleKeys,
): CSSStyleDeclaration[CSSStyleKeys] {
...
export function setClass(el: HTMLElement | SVGElement, name: string): void {
...
export function getClass(
  el: HTMLElement | SVGElementInstance | SVGElement,
): string {
  // Check if the element is an SVGElementInstance and use the correspondingElement instead
  // (Required for linked SVG elements in IE11.)
  if ((el as SVGElementInstance).correspondingElement) {
    el = (el as SVGElementInstance).correspondingElement;
  }
  return (el as SVGElement).className.baseVal === undefined
...
function setOpacityIE(el: HTMLElement, value: number) {
...
export function getPosition(el: HTMLElement): Point {
  ...
  return (el as any)._leaflet_pos || new Point(0, 0);
}
